...
_KEYWORD_TOOLS: dict[str, list[str]] = {
    ...
    "badge": ["achievements"],
    "open": ["app_launcher", "browser", "computer"],
    "launch": ["app_launcher", "computer"],
    "app": ["app_launcher"],
    "notepad": ["app_launcher", "computer"],
    "chrome": ["app_launcher"],
    "whatsapp": ["computer", "app_launcher"],
    "message": ["computer", "notify"],
    "delegate": ["delegate"],
    "learn": ["learning_graph"],
    "concept": ["learning_graph"],
    "graph": ["learning_graph"],
    "knowledge": ["learning_graph"],
    "explore": ["learning_graph"],
    "visualize": ["learning_graph"],
    "connection": ["learning_graph"],
    "confidence": ["learning_graph"],
    ...
    "automate": ["computer"],
    "gui": ["computer"],
    "element": ["screen_vision", "computer"],
    "find element": ["screen_vision", "computer"],
    "click element": ["screen_vision", "computer"],
    "watch screen": ["screen_vision", "computer"],
    "macro": ["screen_vision", "computer"],
    "briefing": ["briefing", "system_info", "todo", "goals"],
    ...
    "obsidian": ["knowledge_vault", "learning_graph"],
    "second brain": ["knowledge_vault", "learning_graph"],
    "note": ["knowledge_vault"],
    "notes": ["knowledge_vault"],
    "swarm": ["delegate"],
    "specialist": ["delegate"],
    "jarvis": ["tts", "transcribe"],
    ...
    "spotify": ["spotify", "music_generate"],
    "music": ["music_generate", "spotify"],
    "song": ["music_generate", "spotify"],
    "beat": ["music_generate"],
    "soundtrack": ["music_generate"],
    "smart home": ["home_assistant", "openhue"],
    "lights": ["openhue", "home_assistant"],
    "hue": ["openhue"],
    "philips hue": ["openhue"],
    "sonos": ["sonos"],
    "speaker": ["sonos"],
    ...
    "blucli": ["blucli"],
    "pair device": ["blucli"],
    "readability": ["web_readability", "url_read"],
    "article": ["web_readability", "url_read"],
    "clean article": ["web_readability"],
    "firecrawl": ["firecrawl_scrape"],
    "crawl": ["firecrawl_scrape"],
    "sitemap": ["firecrawl_scrape"],
    "lsp": ["lsp"],
    "diagnostic": ["lsp"],
    "diagnostics": ["lsp"],
    "hover": ["lsp"],
